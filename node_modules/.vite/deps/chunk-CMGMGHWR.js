...
function createRawEventDispatcher() {
...
function create_if_block_1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(81:0) {#if isDisposableObject(ref)}",
    ctx
  });
  return block;
}
...
function create_if_block(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(85:0) {#if extendsObject3D(ref)}",
    ctx
  });
  return block;
}
function create_default_slot2(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(86:2) <SceneGraphObject object={ref}>",
    ctx
  });
  return block;
}
...
function instance4($$self, $$props, $$invalidate) {
  ...
  let { ref = isClass(is) && argsIsConstructorParameters(args) ? new is(...args) : isClass(is) ? new is() : is } = $$props;
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*initialized, is, args*/
    1120) {
      $:
        if (initialized) {
          $$invalidate(0, ref = isClass(is) && argsIsConstructorParameters(args) ? new is(...args) : isClass(is) ? new is() : is);
        } else {
...
//# sourceMappingURL=chunk-CMGMGHWR.js.map
